...
export class CreateService {
  ...
  update(id: any, date: any, time: any, place: any, imageUrl: any, description: any): Observable<IMeeting> {
    return this.http.put<IMeeting>(`http://localhost:3000/meeting/details/${id}/edit`, {date: date, time: time,place: place,imageUrl: imageUrl,description: description}, {withCredentials: true});
  }
  }
